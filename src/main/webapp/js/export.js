function expt(grid, url, title) {
							...
							for ( var i = 0; i < columns[index].length; ++i) {
								if (!columns[index][i].hidden) {
									...
									if (typeof columns[index][i].field != 'undefined'
											...
											&& typeof columns[index][i].colspan == 'undefined') {
	...
	url = url+"?exportString="+exportString;
	var param2 = {
		doSize : false,
		shadow : false,
		//href:url,
